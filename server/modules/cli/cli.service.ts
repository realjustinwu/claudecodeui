...
function showStatus(dependencies: CliServiceDependencies): void {
  ...
  output.log(`       CONTEXT_WINDOW: ${terminalTextStyles.dim(environment.CONTEXT_WINDOW || '160000 (default; [1m] models use 1000000)')}`);
...
Environment Variables:
  ...
  CONTEXT_WINDOW      Set context window size (default: 160000; [1m] model variants always use 1000000)
